...
var _routes = [
  {name: 'home', path: '/'},
  {name: 'cramupindex', path: '/cramupindex'},
  {name: 'cramupsignin', path: '/cramupsignin'},
  {name: 'cramupsignup', path: '/cramupsignup'},
...
//            }, 100);
  ...
  this.route("flashcard", {
    ...
    waitOn: function () {
      return Meteor.subscribe('currentFlashcard', this.params.flashcardId)
    },
    onBeforeAction: function () {
